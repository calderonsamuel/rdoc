...
`@typedReturn` with JSDoc-like `{type}` syntax 2. **Custom lintr
linter** - Integrates with
...
2.  **Extract** types from accumulated comments when function definition
    found
...
integration (modes: lenient/exported/strict) -
