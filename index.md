...
process_config <- function(parser, roclets) {
  # ...
}
```
...
Validation handles: - Explicit
[`return()`](https://rdrr.io/r/base/function.html) statements - Implicit
returns (last expression) - Literal values and constructors - Comparison
