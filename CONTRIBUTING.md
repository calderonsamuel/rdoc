...
This outlines how to propose a change to rdoc. For a detailed discussion
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("calderonsamuel/rdoc", fork = TRUE)`.
...
Please note that the rdoc project is released with a [Contributor Code
of Conduct](https://calderonsamuel.github.io/rdoc/CODE_OF_CONDUCT.md).
