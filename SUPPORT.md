...
Thanks for using rdoc! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/calderonsamuel/rdoc/issues/new).
...
requests](https://github.com/calderonsamuel/rdoc/issues) to make sure
